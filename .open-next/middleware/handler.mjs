  ...
  ".next/server/edge/chunks/[root-of-the-server]__25fe7590._.js"() {
    ...
    (globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/[root-of-the-server]__25fe7590._.js", 28042, (e, t, r) => {
      ...
      var n = { 226: function(t2, r2) {
        !function(n2, i2) {
          "use strict";
          var o2 = "function", a = "undefined", s = "object", l = "string", u = "major", c = "model", d = "name", p = "type", h = "vendor", f = "version", g = "architecture", b = "console", v = "mobile", m = "tablet", _ = "smarttv", w = "wearable", y = "embedded", x = "Amazon", S = "Apple", O = "ASUS", E = "BlackBerry", R = "Browser", C = "Chrome", P = "Firefox", T = "Google", N = "Huawei", I = "Microsoft", k = "Motorola", M = "Opera", A = "Samsung", j = "Sharp", L = "Sony", D = "Xiaomi", q = "Zebra", U = "Facebook", $ = "Chromium OS", B = "Mac OS", V = function(e2, t3) {
            var r3 = {};
            ...
            return typeof e2 === l && -1 !== X(t3).indexOf(X(e2));
          }, X = function(e2) {
            ...
            return this.getBrowser = function() {
              ...
              return i3 = typeof e3 === l && e3.length > 350 ? W(e3, 350) : e3, this;
            }, this.setUA(i3), this;
          };
      ...
      function E(e2, t2, r2) {
        ...
        return !function e3(t3, r3, n3, u3, c2) {
          ...
          if (b2) return c2 = c2(t3), b2 = "" === u3 ? "." + O(t3, 0) : u3, o(c2) ? (n3 = "", null != b2 && (n3 = b2.replace(S, "$&/") + "/"), e3(c2, r3, n3, "", function(e4) {
            return e4;
          })) : null != c2 && (x(c2) && (d2 = c2, p2 = n3 + (null == c2.key || t3 && t3.key === c2.key ? "" : ("" + c2.key).replace(S, "$&/") + "/") + b2, c2 = y(d2.type, p2, d2.props)), r3.push(c2)), 1;
          b2 = 0;
          var v2 = "" === u3 ? "." : u3 + ":";
          if (o(t3)) for (var _2 = 0; _2 < t3.length; _2++) f2 = v2 + O(u3 = t3[_2], _2), b2 += e3(u3, r3, n3, f2, c2);
...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      var A, j, L, D, q, U, $, B, V, H, G, X, W = e.i(28042);
      ...
      class F extends Request {
        constructor(e10, t2 = {}) {
          ...
          this[z] = { cookies: new W.RequestCookies(this.headers), nextUrl: n2, url: n2.toString() };
        }
        [Symbol.for("edge-runtime.inspect.custom")]() {
      ...
      class Z extends Response {
        constructor(e10, t2 = {}) {
          super(e10, t2);
          const r2 = this.headers, n2 = new Proxy(new W.ResponseCookies(r2), { get(e11, n3, i2) {
            switch (n3) {
              case "delete":
              case "set":
                return (...i3) => {
                  let o2 = Reflect.apply(e11[n3], e11, i3), a2 = new Headers(r2);
                  return o2 instanceof W.ResponseCookies && r2.set("x-middleware-set-cookie", o2.getAll().map((e12) => (0, W.stringifyCookie)(e12)).join(",")), Y(t2, a2), o2;
                };
              default:
      ...
      class eW {
        constructor(e10, t2, r2, n2) {
          ...
          }(t2, e10).isOnDemandRevalidate, a2 = null == (i2 = r2.get(eX)) ? void 0 : i2.value;
              ...
              try {
                ...
                let c3 = te(), d3 = await tr("/", y2.nextUrl, null), p3 = (l2 = y2.nextUrl, u3 = (e11) => {
                  ...
                  return { type: "request", phase: e11, implicitTags: o4, url: { pathname: n4.pathname, search: n4.search ?? "" }, rootParams: i4, get headers() {
                    ...
                    if (!h4.cookies) {
                      let e12 = new W.RequestCookies(eo.from(t3.headers));
                    ...
                    if (!h4.mutableCookies) {
                      var f3, g3;
                      let e12, n5 = (f3 = t3.headers, g3 = a4 || (r4 ? p4 : void 0), e12 = new W.RequestCookies(eo.from(f3)), ef.wrap(e12, g3));
                    ...
                    return h4.draftMode || (h4.draftMode = new eW(l3, t3, this.cookies, this.mutableCookies)), h4.draftMode;
      ...
      let tu = [{ key: "X-DNS-Prefetch-Control", value: "on" }, { key: "Strict-Transport-Security", value: "max-age=63072000; includeSubDomains; preload" }, { key: "X-Frame-Options", value: "SAMEORIGIN" }, { key: "X-Content-Type-Options", value: "nosniff" }, { key: "Referrer-Policy", value: "strict-origin-when-cross-origin" }, { key: "Permissions-Policy", value: "camera=(), microphone=(), geolocation=(), browsing-topics=()" }, { key: "X-XSS-Protection", value: "1; mode=block" }], tc = ["curl", "wget", "scrapy", "python-requests", "python-urllib", "httpclient", "okhttp", "java/", "go-http-client", "node-fetch", "axios", "postman", "insomnia", "httpie", "phantomjs", "headless", "selenium", "puppeteer", "cheerio", "mechanize", "httpunit", "nutch", "httrack", "webcrawler", "webcopy", "sitechecker", "ahrefsbot", "semrushbot", "dotbot", "mj12bot", "bytespider", "petalbot", "yandexbot"], td = ["googlebot", "bingbot", "slurp", "duckduckbot", "baiduspider", "facebookexternalhit", "twitterbot", "linkedinbot", "telegrambot", "whatsapp", "discordbot", "skypeuripreview"], tp = /* @__PURE__ */ new Map(), th = 0;
      function tf(e10) {
        let { pathname: t2, search: r2 } = e10.nextUrl, n2 = e10.headers.get("user-agent") || "", i2 = e10.headers.get("cf-connecting-ip") || e10.headers.get("x-forwarded-for") || "unknown";
        if (t2.startsWith("/api/auth") || t2.startsWith("/_next/static") || t2.startsWith("/_next/image") || t2.startsWith("/favicon.ico") || t2.match(/\.(jpg|jpeg|png|gif|webp|svg|ico|css|js|woff|woff2|ttf|eot)$/)) return Z.next();
        let o2 = n2.toLowerCase();
        if (!td.some((e11) => o2.includes(e11))) {
          if (tc.some((e11) => o2.includes(e11))) return new Z("Access Denied", { status: 403, headers: { "Content-Type": "text/plain", "X-Blocked-Reason": "bot-detected" } });
          if (!n2 || 0 === n2.trim().length) return new Z("Access Denied", { status: 403, headers: { "Content-Type": "text/plain", "X-Blocked-Reason": "missing-user-agent" } });
        }
        if (t2.startsWith("/api/")) {
          ...
          if (!function() {
            ...
            th = 0;
            let e12 = Date.now();
            for (let [t4, r3] of tp.entries()) e12 > r3.resetTime && tp.delete(t4);
          }(), e11 = Date.now(), (t3 = tp.get(i2)) && !(e11 > t3.resetTime) ? (t3.count++, !(t3.count <= 100)) : (tp.set(i2, { count: 1, resetTime: e11 + 6e4 }), false)) return new Z(JSON.stringify({ error: "Too many requests. Please try again later." }), { status: 429, headers: { "Content-Type": "application/json", "Retry-After": "60", "X-RateLimit-Limit": String(100), "X-RateLimit-Window": "60" } });
        }
        let a2 = Z.next();
        return tu.forEach((e11) => {
          a2.headers.set(e11.key, e11.value);
        }), a2.headers.set("X-Powered-By", "CineStream"), a2.headers.set("X-Request-Id", Date.now().toString(36) + Math.random().toString(36).substring(2, 10)), a2;
      }
      e.s(["config", 0, { matcher: ["/((?!_next/static|_next/image|favicon.ico|public/|api/).*)"] }, "middleware", () => tf], 96592);
      var tg = e.i(96592);
      Object.values({ NOT_FOUND: 404, FORBIDDEN: 403, UNAUTHORIZED: 401 });
      let tb = { ...tg }, tv = "/middleware", tm = tb.middleware || tb.default;
      if ("function" != typeof tm) throw new class extends Error {
        constructor(e10) {
          super(e10), this.stack = "";
        }
      }(`The Middleware file "${tv}" must export a function named \`middleware\` or a default function.`);
      e.s(["default", 0, (e10) => ts({ ...e10, page: tv, handler: async (...e11) => {
        try {
          return await tm(...e11);
        } catch (i2) {
...
var init_edgeFunctionHandler = __esm({
  "node_modules/@opennextjs/aws/dist/core/edgeFunctionHandler.js"() {
    ...
    globalThis._ROUTES = [{ "name": "middleware", "page": "/", "regex": ["^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!_next\\/static|_next\\/image|favicon.ico|public\\/|api\\/).*))(\\\\.json)?[\\/#\\?]?$"] }];
...
var NextConfig = { "distDir": ".next", "cacheComponents": false, "htmlLimitedBots": "[\\w-]+-Google|Google-[\\w-]+|Chrome-Lighthouse|Slurp|DuckDuckBot|baiduspider|yandex|sogou|bitlybot|tumblr|vkShare|quora link preview|redditbot|ia_archiver|Bingbot|BingPreview|applebot|facebookexternalhit|facebookcatalog|Twitterbot|LinkedInBot|Slackbot|Discordbot|WhatsApp|SkypeUriPreview|Yeti|googleweblight", "assetPrefix": "", "output": "standalone", "trailingSlash": false, "images": { "deviceSizes": [640, 750, 828, 1080, 1200, 1920, 2048, 3840], "imageSizes": [32, 48, 64, 96, 128, 256, 384], "path": "/_next/image", "loader": "default", "loaderFile": "", "domains": [], "disableStaticImages": false, "minimumCacheTTL": 14400, "formats": ["image/webp"], "maximumRedirects": 3, "dangerouslyAllowLocalIP": false, "dangerouslyAllowSVG": false, "contentSecurityPolicy": "script-src 'none'; frame-src 'none'; sandbox;", "contentDispositionType": "attachment", "localPatterns": [{ "pathname": "**", "search": "" }], "remotePatterns": [{ "protocol": "https", "hostname": "image.tmdb.org" }, { "protocol": "https", "hostname": "images.unsplash.com" }, { "protocol": "https", "hostname": "otakudesu.blog" }, { "protocol": "https", "hostname": "v1.animasu.work" }, { "protocol": "https", "hostname": "i0.wp.com" }, { "protocol": "https", "hostname": "i1.wp.com" }, { "protocol": "https", "hostname": "i2.wp.com" }, { "protocol": "https", "hostname": "i3.wp.com" }, { "protocol": "https", "hostname": "anichin.cafe" }, { "protocol": "https", "hostname": "donghub.vip" }, { "protocol": "https", "hostname": "thumbnail.komiku.org" }, { "protocol": "https", "hostname": "img.komiku.org" }, { "protocol": "https", "hostname": "img1.komiku.org" }, { "protocol": "https", "hostname": "img2.komiku.org" }, { "protocol": "https", "hostname": "img3.komiku.org" }, { "protocol": "https", "hostname": "cdn.myanimelist.net" }], "qualities": [75], "unoptimized": true }, "reactMaxHeadersLength": 6e3, "cacheLife": { "default": { "stale": 300, "revalidate": 900, "expire": 4294967294 }, "seconds": { "stale": 30, "revalidate": 1, "expire": 60 }, "minutes": { "stale": 300, "revalidate": 60, "expire": 3600 }, "hours": { "stale": 300, "revalidate": 3600, "expire": 86400 }, "days": { "stale": 300, "revalidate": 86400, "expire": 604800 }, "weeks": { "stale": 300, "revalidate": 604800, "expire": 2592e3 }, "max": { "stale": 300, "revalidate": 2592e3, "expire": 31536e3 } }, "basePath": "", "expireTime": 31536e3, "generateEtags": true, "poweredByHeader": true, "cacheHandlers": {}, "cacheMaxMemorySize": 52428800, "compress": true, "i18n": null, "httpAgentOptions": { "keepAlive": true }, "pageExtensions": ["tsx", "ts", "jsx", "js"], "useFileSystemPublicRoutes": true, "experimental": { "ppr": false, "staleTimes": { "dynamic": 0, "static": 300 }, "dynamicOnHover": false, "inlineCss": false, "authInterrupts": false, "fetchCacheKeyPrefix": "", "isrFlushToDisk": true, "optimizeCss": false, "nextScriptWorkers": false, "disableOptimizedLoading": false, "largePageDataBytes": 128e3, "serverComponentsHmrCache": true, "caseSensitiveRoutes": false, "validateRSCRequestHeaders": false, "useSkewCookie": false, "preloadEntriesOnStart": true, "hideLogsAfterAbort": false, "removeUncaughtErrorAndRejectionListeners": false, "imgOptConcurrency": null, "imgOptMaxInputPixels": 268402689, "imgOptSequentialRead": null, "imgOptSkipMetadata": null, "imgOptTimeoutInSeconds": 7, "proxyClientMaxBodySize": 10485760, "trustHostHeader": false, "isExperimentalCompile": false }, "skipTrailingSlashRedirect": false, "serverExternalPackages": [] };
var BuildId = "v4-proxy-1787371677974";
var RoutesManifest = { "basePath": "", "rewrites": { "beforeFiles": [], "afterFiles": [], "fallback": [] }, "redirects": [{ "source": "/:path+/", "destination": "/:path+", "internal": true, "priority": true, "statusCode": 308, "regex": "^(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))/$" }], "routes": { "static": [{ "page": "/", "regex": "^/(?:/)?$", "routeKeys": {}, "namedRegex": "^/(?:/)?$" }, { "page": "/_global-error", "regex": "^/_global\\-error(?:/)?$", "routeKeys": {}, "namedRegex": "^/_global\\-error(?:/)?$" }, { "page": "/_not-found", "regex": "^/_not\\-found(?:/)?$", "routeKeys": {}, "namedRegex": "^/_not\\-found(?:/)?$" }, { "page": "/admin", "regex": "^/admin(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin(?:/)?$" }, { "page": "/admin/ads", "regex": "^/admin/ads(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/ads(?:/)?$" }, { "page": "/admin/analytics", "regex": "^/admin/analytics(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/analytics(?:/)?$" }, { "page": "/admin/badges", "regex": "^/admin/badges(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/badges(?:/)?$" }, { "page": "/admin/curated", "regex": "^/admin/curated(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/curated(?:/)?$" }, { "page": "/admin/logs", "regex": "^/admin/logs(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/logs(?:/)?$" }, { "page": "/admin/messages", "regex": "^/admin/messages(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/messages(?:/)?$" }, { "page": "/admin/providers", "regex": "^/admin/providers(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/providers(?:/)?$" }, { "page": "/admin/subtitle", "regex": "^/admin/subtitle(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/subtitle(?:/)?$" }, { "page": "/admin/subtitle/batch", "regex": "^/admin/subtitle/batch(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/subtitle/batch(?:/)?$" }, { "page": "/admin/subtitle/generate", "regex": "^/admin/subtitle/generate(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/subtitle/generate(?:/)?$" }, { "page": "/admin/users", "regex": "^/admin/users(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/users(?:/)?$" }, { "page": "/anime", "regex": "^/anime(?:/)?$", "routeKeys": {}, "namedRegex": "^/anime(?:/)?$" }, { "page": "/anime/search", "regex": "^/anime/search(?:/)?$", "routeKeys": {}, "namedRegex": "^/anime/search(?:/)?$" }, { "page": "/api", "regex": "^/api(?:/)?$", "routeKeys": {}, "namedRegex": "^/api(?:/)?$" }, { "page": "/api/admin/ads", "regex": "^/api/admin/ads(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/admin/ads(?:/)?$" }, { "page": "/api/admin/analytics", "regex": "^/api/admin/analytics(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/admin/analytics(?:/)?$" }, { "page": "/api/admin/cinemacity-cookies", "regex": "^/api/admin/cinemacity\\-cookies(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/admin/cinemacity\\-cookies(?:/)?$" }, { "page": "/api/admin/curated", "regex": "^/api/admin/curated(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/admin/curated(?:/)?$" }, { "page": "/api/admin/logs", "regex": "^/api/admin/logs(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/admin/logs(?:/)?$" }, { "page": "/api/admin/messages", "regex": "^/api/admin/messages(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/admin/messages(?:/)?$" }, { "page": "/api/admin/providers", "regex": "^/api/admin/providers(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/admin/providers(?:/)?$" }, { "page": "/api/admin/stats", "regex": "^/api/admin/stats(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/admin/stats(?:/)?$" }, { "page": "/api/admin/subtitle", "regex": "^/api/admin/subtitle(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/admin/subtitle(?:/)?$" }, { "page": "/api/admin/users", "regex": "^/api/admin/users(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/admin/users(?:/)?$" }, { "page": "/api/ads/config", "regex": "^/api/ads/config(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/ads/config(?:/)?$" }, { "page": "/api/analytics", "regex": "^/api/analytics(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/analytics(?:/)?$" }, { "page": "/api/auth/register", "regex": "^/api/auth/register(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/auth/register(?:/)?$" }, { "page": "/api/badges", "regex": "^/api/badges(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/badges(?:/)?$" }, { "page": "/api/cinemacity/genres", "regex": "^/api/cinemacity/genres(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/cinemacity/genres(?:/)?$" }, { "page": "/api/cinemacity/home", "regex": "^/api/cinemacity/home(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/cinemacity/home(?:/)?$" }, { "page": "/api/cinemacity/image", "regex": "^/api/cinemacity/image(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/cinemacity/image(?:/)?$" }, { "page": "/api/cinemacity/proxy", "regex": "^/api/cinemacity/proxy(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/cinemacity/proxy(?:/)?$" }, { "page": "/api/cinemacity/scrape", "regex": "^/api/cinemacity/scrape(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/cinemacity/scrape(?:/)?$" }, { "page": "/api/cinemacity/search", "regex": "^/api/cinemacity/search(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/cinemacity/search(?:/)?$" }, { "page": "/api/cinemacity/stream", "regex": "^/api/cinemacity/stream(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/cinemacity/stream(?:/)?$" }, { "page": "/api/cinemacity/test-bypass", "regex": "^/api/cinemacity/test\\-bypass(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/cinemacity/test\\-bypass(?:/)?$" }, { "page": "/api/comic/filters", "regex": "^/api/comic/filters(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/comic/filters(?:/)?$" }, { "page": "/api/comic/home", "regex": "^/api/comic/home(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/comic/home(?:/)?$" }, { "page": "/api/comic/populer", "regex": "^/api/comic/populer(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/comic/populer(?:/)?$" }, { "page": "/api/comic/search", "regex": "^/api/comic/search(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/comic/search(?:/)?$" }, { "page": "/api/comic/terbaru", "regex": "^/api/comic/terbaru(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/comic/terbaru(?:/)?$" }, { "page": "/api/comments", "regex": "^/api/comments(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/comments(?:/)?$" }, { "page": "/api/cron/check-updates", "regex": "^/api/cron/check\\-updates(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/cron/check\\-updates(?:/)?$" }, { "page": "/api/cron/refresh-cookies", "regex": "^/api/cron/refresh\\-cookies(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/cron/refresh\\-cookies(?:/)?$" }, { "page": "/api/debug", "regex": "^/api/debug(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/debug(?:/)?$" }, { "page": "/api/debug-db", "regex": "^/api/debug\\-db(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/debug\\-db(?:/)?$" }, { "page": "/api/debug-eps", "regex": "^/api/debug\\-eps(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/debug\\-eps(?:/)?$" }, { "page": "/api/drakor/kategori", "regex": "^/api/drakor/kategori(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/drakor/kategori(?:/)?$" }, { "page": "/api/drakor/ongoing", "regex": "^/api/drakor/ongoing(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/drakor/ongoing(?:/)?$" }, { "page": "/api/drakor/play", "regex": "^/api/drakor/play(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/drakor/play(?:/)?$" }, { "page": "/api/drakor/search", "regex": "^/api/drakor/search(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/drakor/search(?:/)?$" }, { "page": "/api/drakor/terbaru", "regex": "^/api/drakor/terbaru(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/drakor/terbaru(?:/)?$" }, { "page": "/api/drakor/trending", "regex": "^/api/drakor/trending(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/drakor/trending(?:/)?$" }, { "page": "/api/history", "regex": "^/api/history(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/history(?:/)?$" }, { "page": "/api/home", "regex": "^/api/home(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/home(?:/)?$" }, { "page": "/api/messages", "regex": "^/api/messages(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/messages(?:/)?$" }, { "page": "/api/notifications", "regex": "^/api/notifications(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/notifications(?:/)?$" }, { "page": "/api/providers", "regex": "^/api/providers(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/providers(?:/)?$" }, { "page": "/api/proxy-image", "regex": "^/api/proxy\\-image(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/proxy\\-image(?:/)?$" }, { "page": "/api/ratings", "regex": "^/api/ratings(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/ratings(?:/)?$" }, { "page": "/api/subtitle/manual", "regex": "^/api/subtitle/manual(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/subtitle/manual(?:/)?$" }, { "page": "/api/user/language", "regex": "^/api/user/language(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/user/language(?:/)?$" }, { "page": "/api/user/profile", "regex": "^/api/user/profile(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/user/profile(?:/)?$" }, { "page": "/api/watchlist", "regex": "^/api/watchlist(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/watchlist(?:/)?$" }, { "page": "/comic", "regex": "^/comic(?:/)?$", "routeKeys": {}, "namedRegex": "^/comic(?:/)?$" }, { "page": "/donghua", "regex": "^/donghua(?:/)?$", "routeKeys": {}, "namedRegex": "^/donghua(?:/)?$" }, { "page": "/donghua/s1", "regex": "^/donghua/s1(?:/)?$", "routeKeys": {}, "namedRegex": "^/donghua/s1(?:/)?$" }, { "page": "/drakor", "regex": "^/drakor(?:/)?$", "routeKeys": {}, "namedRegex": "^/drakor(?:/)?$" }, { "page": "/history", "regex": "^/history(?:/)?$", "routeKeys": {}, "namedRegex": "^/history(?:/)?$" }, { "page": "/movies", "regex": "^/movies(?:/)?$", "routeKeys": {}, "namedRegex": "^/movies(?:/)?$" }, { "page": "/new", "regex": "^/new(?:/)?$", "routeKeys": {}, "namedRegex": "^/new(?:/)?$" }, { "page": "/novel", "regex": "^/novel(?:/)?$", "routeKeys": {}, "namedRegex": "^/novel(?:/)?$" }, { "page": "/profile", "regex": "^/profile(?:/)?$", "routeKeys": {}, "namedRegex": "^/profile(?:/)?$" }, { "page": "/search", "regex": "^/search(?:/)?$", "routeKeys": {}, "namedRegex": "^/search(?:/)?$" }, { "page": "/tv", "regex": "^/tv(?:/)?$", "routeKeys": {}, "namedRegex": "^/tv(?:/)?$" }, { "page": "/watchlist", "regex": "^/watchlist(?:/)?$", "routeKeys": {}, "namedRegex": "^/watchlist(?:/)?$" }], "dynamic": [{ "page": "/anime/s1/genre/[slug]", "regex": "^/anime/s1/genre/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/anime/s1/genre/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/anime/s1/watch/[id]/[episode]", "regex": "^/anime/s1/watch/([^/]+?)/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid", "nxtPepisode": "nxtPepisode" }, "namedRegex": "^/anime/s1/watch/(?<nxtPid>[^/]+?)/(?<nxtPepisode>[^/]+?)(?:/)?$" }, { "page": "/anime/s1/[id]", "regex": "^/anime/s1/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/anime/s1/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/anime/s2/genre/[slug]", "regex": "^/anime/s2/genre/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/anime/s2/genre/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/anime/s2/watch/[id]/[episode]", "regex": "^/anime/s2/watch/([^/]+?)/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid", "nxtPepisode": "nxtPepisode" }, "namedRegex": "^/anime/s2/watch/(?<nxtPid>[^/]+?)/(?<nxtPepisode>[^/]+?)(?:/)?$" }, { "page": "/anime/s2/[id]", "regex": "^/anime/s2/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/anime/s2/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/admin/ads/[id]", "regex": "^/api/admin/ads/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/admin/ads/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/admin/cinemacity-cookies/[id]", "regex": "^/api/admin/cinemacity\\-cookies/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/admin/cinemacity\\-cookies/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/admin/curated/[id]", "regex": "^/api/admin/curated/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/admin/curated/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/admin/messages/[id]", "regex": "^/api/admin/messages/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/admin/messages/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/admin/providers/[id]", "regex": "^/api/admin/providers/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/admin/providers/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/admin/subtitle/[id]", "regex": "^/api/admin/subtitle/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/admin/subtitle/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/anime/[...path]", "regex": "^/api/anime/(.+?)(?:/)?$", "routeKeys": { "nxtPpath": "nxtPpath" }, "namedRegex": "^/api/anime/(?<nxtPpath>.+?)(?:/)?$" }, { "page": "/api/auth/[...nextauth]", "regex": "^/api/auth/(.+?)(?:/)?$", "routeKeys": { "nxtPnextauth": "nxtPnextauth" }, "namedRegex": "^/api/auth/(?<nxtPnextauth>.+?)(?:/)?$" }, { "page": "/api/cinemacity/genre/[genre]", "regex": "^/api/cinemacity/genre/([^/]+?)(?:/)?$", "routeKeys": { "nxtPgenre": "nxtPgenre" }, "namedRegex": "^/api/cinemacity/genre/(?<nxtPgenre>[^/]+?)(?:/)?$" }, { "page": "/api/cinemacity/movie/[slug]", "regex": "^/api/cinemacity/movie/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/api/cinemacity/movie/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/api/cinemacity/play/[slug]", "regex": "^/api/cinemacity/play/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/api/cinemacity/play/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/api/comic/detail/[slug]", "regex": "^/api/comic/detail/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/api/comic/detail/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/api/comic/view/[slug]/[chapter]", "regex": "^/api/comic/view/([^/]+?)/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug", "nxtPchapter": "nxtPchapter" }, "namedRegex": "^/api/comic/view/(?<nxtPslug>[^/]+?)/(?<nxtPchapter>[^/]+?)(?:/)?$" }, { "page": "/api/comic/[...path]", "regex": "^/api/comic/(.+?)(?:/)?$", "routeKeys": { "nxtPpath": "nxtPpath" }, "namedRegex": "^/api/comic/(?<nxtPpath>.+?)(?:/)?$" }, { "page": "/api/donghua/donghua/detail/[slug]", "regex": "^/api/donghua/donghua/detail/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/api/donghua/donghua/detail/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/api/donghua/donghua/episode/[slug]", "regex": "^/api/donghua/donghua/episode/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/api/donghua/donghua/episode/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/api/donghua/[...path]", "regex": "^/api/donghua/(.+?)(?:/)?$", "routeKeys": { "nxtPpath": "nxtPpath" }, "namedRegex": "^/api/donghua/(?<nxtPpath>.+?)(?:/)?$" }, { "page": "/api/drakor/detail/[slug]", "regex": "^/api/drakor/detail/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/api/drakor/detail/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/api/drakor/kategori/[slug]", "regex": "^/api/drakor/kategori/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/api/drakor/kategori/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/api/indocast/[...path]", "regex": "^/api/indocast/(.+?)(?:/)?$", "routeKeys": { "nxtPpath": "nxtPpath" }, "namedRegex": "^/api/indocast/(?<nxtPpath>.+?)(?:/)?$" }, { "page": "/api/messages/[id]", "regex": "^/api/messages/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/messages/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/stream/[...path]", "regex": "^/api/stream/(.+?)(?:/)?$", "routeKeys": { "nxtPpath": "nxtPpath" }, "namedRegex": "^/api/stream/(?<nxtPpath>.+?)(?:/)?$" }, { "page": "/api/user/[id]/badges", "regex": "^/api/user/([^/]+?)/badges(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/user/(?<nxtPid>[^/]+?)/badges(?:/)?$" }, { "page": "/api/user/[id]/equip", "regex": "^/api/user/([^/]+?)/equip(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/user/(?<nxtPid>[^/]+?)/equip(?:/)?$" }, { "page": "/api/vps/[...path]", "regex": "^/api/vps/(.+?)(?:/)?$", "routeKeys": { "nxtPpath": "nxtPpath" }, "namedRegex": "^/api/vps/(?<nxtPpath>.+?)(?:/)?$" }, { "page": "/comic/genre/[slug]", "regex": "^/comic/genre/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/comic/genre/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/comic/list/[type]", "regex": "^/comic/list/([^/]+?)(?:/)?$", "routeKeys": { "nxtPtype": "nxtPtype" }, "namedRegex": "^/comic/list/(?<nxtPtype>[^/]+?)(?:/)?$" }, { "page": "/comic/read/[slug]", "regex": "^/comic/read/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/comic/read/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/comic/read/[slug]/[chapter]", "regex": "^/comic/read/([^/]+?)/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug", "nxtPchapter": "nxtPchapter" }, "namedRegex": "^/comic/read/(?<nxtPslug>[^/]+?)/(?<nxtPchapter>[^/]+?)(?:/)?$" }, { "page": "/comic/[slug]", "regex": "^/comic/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/comic/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/donghua/s1/genre/[slug]", "regex": "^/donghua/s1/genre/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/donghua/s1/genre/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/donghua/s1/list/[type]", "regex": "^/donghua/s1/list/([^/]+?)(?:/)?$", "routeKeys": { "nxtPtype": "nxtPtype" }, "namedRegex": "^/donghua/s1/list/(?<nxtPtype>[^/]+?)(?:/)?$" }, { "page": "/donghua/s1/watch/[id]/[episode]", "regex": "^/donghua/s1/watch/([^/]+?)/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid", "nxtPepisode": "nxtPepisode" }, "namedRegex": "^/donghua/s1/watch/(?<nxtPid>[^/]+?)/(?<nxtPepisode>[^/]+?)(?:/)?$" }, { "page": "/donghua/s1/[id]", "regex": "^/donghua/s1/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/donghua/s1/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/donghua/s2/genre/[slug]", "regex": "^/donghua/s2/genre/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/donghua/s2/genre/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/donghua/s2/watch/[id]/[episode]", "regex": "^/donghua/s2/watch/([^/]+?)/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid", "nxtPepisode": "nxtPepisode" }, "namedRegex": "^/donghua/s2/watch/(?<nxtPid>[^/]+?)/(?<nxtPepisode>[^/]+?)(?:/)?$" }, { "page": "/donghua/s2/[id]", "regex": "^/donghua/s2/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/donghua/s2/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/drakor/kategori/[slug]", "regex": "^/drakor/kategori/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/drakor/kategori/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/drakor/list/[type]", "regex": "^/drakor/list/([^/]+?)(?:/)?$", "routeKeys": { "nxtPtype": "nxtPtype" }, "namedRegex": "^/drakor/list/(?<nxtPtype>[^/]+?)(?:/)?$" }, { "page": "/drakor/watch/[slug]/[episode]", "regex": "^/drakor/watch/([^/]+?)/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug", "nxtPepisode": "nxtPepisode" }, "namedRegex": "^/drakor/watch/(?<nxtPslug>[^/]+?)/(?<nxtPepisode>[^/]+?)(?:/)?$" }, { "page": "/drakor/[slug]", "regex": "^/drakor/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/drakor/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/genre/[slug]", "regex": "^/genre/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/genre/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/person/[id]", "regex": "^/person/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/person/(?<nxtPid>[^/]+?)(?:/)?$" }], "data": { "static": [], "dynamic": [] } }, "locales": [] };
var ConfigHeaders = [];
var PrerenderManifest = { "version": 4, "routes": { "/_global-error": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/_global-error", "dataRoute": "/_global-error.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/anime/search": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/anime/search", "dataRoute": "/anime/search.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/", "dataRoute": "/index.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/profile": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/profile", "dataRoute": "/profile.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] } }, "dynamicRoutes": {}, "notFoundRoutes": [], "preview": { "previewModeId": "37bd9cbcadcf29b7afbf51bdef96b029", "previewModeSigningKey": "1e132e9025a8c20baad2440ea08bad1efde03194c68aebc19bc0316ce82a75bc", "previewModeEncryptionKey": "c172526791c38957be93cc62971fc2523cd15fbd3cad372704a63c6ac57f077b" } };
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge/chunks/node_modules_next_dist_esm_build_templates_edge-wrapper_78fa9d6a.js", "server/edge/chunks/[root-of-the-server]__25fe7590._.js", "server/edge/chunks/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_99e3e1b8.js"], "name": "middleware", "page": "/", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!_next\\/static|_next\\/image|favicon.ico|public\\/|api\\/).*))(\\\\.json)?[\\/#\\?]?$", "originalSource": "/((?!_next/static|_next/image|favicon.ico|public/|api/).*)" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "v4-proxy-1787371677974", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "mhv60lvntXKZnMJXisNDF00ZzPQpOnA7HR1RAKULCcQ=", "__NEXT_PREVIEW_MODE_ID": "37bd9cbcadcf29b7afbf51bdef96b029", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "c172526791c38957be93cc62971fc2523cd15fbd3cad372704a63c6ac57f077b", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "1e132e9025a8c20baad2440ea08bad1efde03194c68aebc19bc0316ce82a75bc" } } }, "sortedMiddleware": ["/"], "functions": {} };
var AppPathRoutesManifest = { "/_global-error/page": "/_global-error", "/_not-found/page": "/_not-found", "/admin/ads/page": "/admin/ads", "/admin/analytics/page": "/admin/analytics", "/admin/badges/page": "/admin/badges", "/admin/curated/page": "/admin/curated", "/admin/logs/page": "/admin/logs", "/admin/messages/page": "/admin/messages", "/admin/page": "/admin", "/admin/providers/page": "/admin/providers", "/admin/subtitle/batch/page": "/admin/subtitle/batch", "/admin/subtitle/generate/page": "/admin/subtitle/generate", "/admin/subtitle/page": "/admin/subtitle", "/admin/users/page": "/admin/users", "/anime/page": "/anime", "/anime/s1/[id]/page": "/anime/s1/[id]", "/anime/s1/genre/[slug]/page": "/anime/s1/genre/[slug]", "/anime/s1/watch/[id]/[episode]/page": "/anime/s1/watch/[id]/[episode]", "/anime/s2/[id]/page": "/anime/s2/[id]", "/anime/s2/genre/[slug]/page": "/anime/s2/genre/[slug]", "/anime/s2/watch/[id]/[episode]/page": "/anime/s2/watch/[id]/[episode]", "/anime/search/page": "/anime/search", "/api/admin/ads/[id]/route": "/api/admin/ads/[id]", "/api/admin/ads/route": "/api/admin/ads", "/api/admin/analytics/route": "/api/admin/analytics", "/api/admin/cinemacity-cookies/[id]/route": "/api/admin/cinemacity-cookies/[id]", "/api/admin/cinemacity-cookies/route": "/api/admin/cinemacity-cookies", "/api/admin/curated/[id]/route": "/api/admin/curated/[id]", "/api/admin/curated/route": "/api/admin/curated", "/api/admin/logs/route": "/api/admin/logs", "/api/admin/messages/[id]/route": "/api/admin/messages/[id]", "/api/admin/messages/route": "/api/admin/messages", "/api/admin/providers/[id]/route": "/api/admin/providers/[id]", "/api/admin/providers/route": "/api/admin/providers", "/api/admin/stats/route": "/api/admin/stats", "/api/admin/subtitle/[id]/route": "/api/admin/subtitle/[id]", "/api/admin/subtitle/route": "/api/admin/subtitle", "/api/admin/users/route": "/api/admin/users", "/api/ads/config/route": "/api/ads/config", "/api/analytics/route": "/api/analytics", "/api/anime/[...path]/route": "/api/anime/[...path]", "/api/auth/[...nextauth]/route": "/api/auth/[...nextauth]", "/api/auth/register/route": "/api/auth/register", "/api/badges/route": "/api/badges", "/api/cinemacity/genre/[genre]/route": "/api/cinemacity/genre/[genre]", "/api/cinemacity/genres/route": "/api/cinemacity/genres", "/api/cinemacity/home/route": "/api/cinemacity/home", "/api/cinemacity/image/route": "/api/cinemacity/image", "/api/cinemacity/movie/[slug]/route": "/api/cinemacity/movie/[slug]", "/api/cinemacity/play/[slug]/route": "/api/cinemacity/play/[slug]", "/api/cinemacity/proxy/route": "/api/cinemacity/proxy", "/api/cinemacity/scrape/route": "/api/cinemacity/scrape", "/api/cinemacity/search/route": "/api/cinemacity/search", "/api/cinemacity/stream/route": "/api/cinemacity/stream", "/api/cinemacity/test-bypass/route": "/api/cinemacity/test-bypass", "/api/comic/[...path]/route": "/api/comic/[...path]", "/api/comic/detail/[slug]/route": "/api/comic/detail/[slug]", "/api/comic/filters/route": "/api/comic/filters", "/api/comic/home/route": "/api/comic/home", "/api/comic/populer/route": "/api/comic/populer", "/api/comic/search/route": "/api/comic/search", "/api/comic/terbaru/route": "/api/comic/terbaru", "/api/comic/view/[slug]/[chapter]/route": "/api/comic/view/[slug]/[chapter]", "/api/comments/route": "/api/comments", "/api/cron/check-updates/route": "/api/cron/check-updates", "/api/cron/refresh-cookies/route": "/api/cron/refresh-cookies", "/api/debug-db/route": "/api/debug-db", "/api/debug-eps/route": "/api/debug-eps", "/api/debug/route": "/api/debug", "/api/donghua/[...path]/route": "/api/donghua/[...path]", "/api/donghua/donghua/detail/[slug]/route": "/api/donghua/donghua/detail/[slug]", "/api/donghua/donghua/episode/[slug]/route": "/api/donghua/donghua/episode/[slug]", "/api/drakor/detail/[slug]/route": "/api/drakor/detail/[slug]", "/api/drakor/kategori/[slug]/route": "/api/drakor/kategori/[slug]", "/api/drakor/kategori/route": "/api/drakor/kategori", "/api/drakor/ongoing/route": "/api/drakor/ongoing", "/api/drakor/play/route": "/api/drakor/play", "/api/drakor/search/route": "/api/drakor/search", "/api/drakor/terbaru/route": "/api/drakor/terbaru", "/api/drakor/trending/route": "/api/drakor/trending", "/api/history/route": "/api/history", "/api/home/route": "/api/home", "/api/indocast/[...path]/route": "/api/indocast/[...path]", "/api/messages/[id]/route": "/api/messages/[id]", "/api/messages/route": "/api/messages", "/api/notifications/route": "/api/notifications", "/api/providers/route": "/api/providers", "/api/proxy-image/route": "/api/proxy-image", "/api/ratings/route": "/api/ratings", "/api/route": "/api", "/api/stream/[...path]/route": "/api/stream/[...path]", "/api/subtitle/manual/route": "/api/subtitle/manual", "/api/user/[id]/badges/route": "/api/user/[id]/badges", "/api/user/[id]/equip/route": "/api/user/[id]/equip", "/api/user/language/route": "/api/user/language", "/api/user/profile/route": "/api/user/profile", "/api/vps/[...path]/route": "/api/vps/[...path]", "/api/watchlist/route": "/api/watchlist", "/comic/[slug]/page": "/comic/[slug]", "/comic/genre/[slug]/page": "/comic/genre/[slug]", "/comic/list/[type]/page": "/comic/list/[type]", "/comic/page": "/comic", "/comic/read/[slug]/[chapter]/page": "/comic/read/[slug]/[chapter]", "/comic/read/[slug]/page": "/comic/read/[slug]", "/donghua/page": "/donghua", "/donghua/s1/[id]/page": "/donghua/s1/[id]", "/donghua/s1/genre/[slug]/page": "/donghua/s1/genre/[slug]", "/donghua/s1/list/[type]/page": "/donghua/s1/list/[type]", "/donghua/s1/page": "/donghua/s1", "/donghua/s1/watch/[id]/[episode]/page": "/donghua/s1/watch/[id]/[episode]", "/donghua/s2/[id]/page": "/donghua/s2/[id]", "/donghua/s2/genre/[slug]/page": "/donghua/s2/genre/[slug]", "/donghua/s2/watch/[id]/[episode]/page": "/donghua/s2/watch/[id]/[episode]", "/drakor/[slug]/page": "/drakor/[slug]", "/drakor/kategori/[slug]/page": "/drakor/kategori/[slug]", "/drakor/list/[type]/page": "/drakor/list/[type]", "/drakor/page": "/drakor", "/drakor/watch/[slug]/[episode]/page": "/drakor/watch/[slug]/[episode]", "/genre/[slug]/page": "/genre/[slug]", "/history/page": "/history", "/movies/page": "/movies", "/new/page": "/new", "/novel/page": "/novel", "/page": "/", "/person/[id]/page": "/person/[id]", "/profile/page": "/profile", "/search/page": "/search", "/tv/page": "/tv", "/watchlist/page": "/watchlist" };
