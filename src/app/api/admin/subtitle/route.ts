/**
 * src/app/api/admin/subtitle/route.ts
 *
 * GET  /api/admin/subtitle          - List all subtitles
 * POST /api/admin/subtitle          - Upsert subtitle (upload/replace)
 *
...
export async function GET(request: NextRequest) {
  ...
  try {
    const subtitles = await listManualSubtitles();
