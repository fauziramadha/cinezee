          ...
          {loading ? (
            ...
            <div className="fade-in pb-16">
              ...
              <div className="flex flex-wrap items-center gap-2 border-b border-border bg-card/50 px-4 py-3 sm:gap-3 sm:px-6 md:px-8">
                ...
                <Button size="icon" variant="outline" aria-label="Share" onClick={() => {  if (navigator.share) {    navigator.share({ title: title, text: `Tonton ${title} di CineStream!`, url: window.location.href }).catch(() => {});  } else {    navigator.clipboard.writeText(window.location.href);    toast.success("Link disalin ke clipboard!");  }}}><Share2 className="h-4 w-4" /></Button>
              </div>
