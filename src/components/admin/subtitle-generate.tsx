...
export function SubtitleGenerate() {
  ...
  const handleGenerate = () => {
    ...
    // FIX: Pakai chr(10) untuk newline di Python print, supaya pasti safe di clipboard
    // Tidak ada \n di dalam string Python yang bisa ke-interpretasi sebagai literal newline
    const colabScript = [
      "# ============================================================",
      ...
      "# Extract audio dari HLS stream (m3u8) ke WAV 16kHz mono (optimal untuk Whisper)",
      ...
      "",
      "NL = chr(10)  # newline character (safe untuk clipboard)",
      ...
      "    print('SUCCESS! Subtitle sudah tersimpan di CineStream.')",
