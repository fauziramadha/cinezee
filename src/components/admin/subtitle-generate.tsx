...
export function SubtitleGenerate() {
  ...
  const handleGenerate = () => {
    ...
    const lines = [
      ...
      "import whisper",
      f"print(f'Loading Whisper model ({MODEL_NAME})...')",
      ...
      f"print(f'Transcribed {len(segments_list)} segments')",
      "",
      ...
      f"print(f'VTT generated ({len(vtt_content)} chars, {len(segments_list)} cues)')",
